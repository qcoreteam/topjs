...
Object.assign(StandardAutoloader, /** @lends TopJs.kernel.loader.StandardAutoloader */{
    /**
     * @readonly
     * @static
...
Object.assign(StandardAutoloader.prototype, /** @lends TopJs.kernel.loader.StandardAutoloader.prototype */ {
    /**
     * @protected
    ...
    require(className)
    {
        let ns = this.getNamespace(className);
    },
