...
`;
   ...
   TopJs.apply(dateObj, /** @lends TopJs.Date */{
      ...
      add(date, interval, value)
      {
         ...
         if(decimalValue){
            switch(interval.toLowerCase()){
               case dateObj.MILLI:    base = 1;               break;
               case dateObj.SECOND:   base = 1000;            break;
               case dateObj.MINUTE:   base = 1000*60;         break;
               case dateObj.HOUR:     base = 1000*60*60;      break;
               case dateObj.DAY:      base = 1000*60*60*24;   break;
               case dateObj.MONTH:
      ...
      clone(date)
      {
         return nativeDate(date.getTime());
      },
