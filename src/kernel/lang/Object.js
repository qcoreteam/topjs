...
export function mount(TopJs)
{
   ...
   TopJs.apply(TopJsObj, /** @lends TopJs.Object */{
      ...
      toQueryString(object, recursive)
      {
         ...
         for(let i = 0; i < len; i++){
            ...
            if(TopJs.isEmpty(paramValue)){
               ...
               value = TopJs.Date.toString(paramValue);
            }
            params.push(encodeURIComponent(param.name, paramValue));
         }
         return params.join('&');
      },
      ...
      equals(object1, object2)
      {
         ...
         if(object1 && object2){
            return TopJsObj.check(object1, object2) && TopJs.check(object2, object1);
